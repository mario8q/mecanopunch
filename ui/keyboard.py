...
class VirtualKeyboard:
    ...
    def on_key_press(self, event) -> None:
        ...
        """
        self.last_keysym_pressed = event.keysym
    ...
    def on_key_release(self, event) -> None:
        ...
        """
        keysym = self.last_keysym_pressed if event.keysym in ["Shift_L", "Shift_R"] else event.keysym
...
class VirtualKeyboardCorrupted(VirtualKeyboard):
    ...
    def create_keyboard(self):
        ...
        """
        # Estilo diferente y diseño azerty visible (solo apariencia)
        self.layout_name: LayoutName = LayoutName.QWERTY  # type: ignore[attr-defined]
    ...
    def translate_corrupted_keys(self, symbol: str) -> str:
        """
        Funcion que traduce el symbolo en teclado QWERTY a AZERTY
        """
    ...
    def on_key_press(self, event) -> None:
        ...
        """
        self.last_keysym_pressed: str = event.keysym
    ...
    def on_key_release(self, event) -> None:
        ...
        """
        keysym: Union[str, None] = self.last_keysym_pressed if event.keysym in ["Shift_L", "Shift_R"] else event.keysym
        translated: str = self.translate_corrupted_keys(event.keysym)
        matching_key: Union[Optional[kl.Key], None] = next((k for k in Key if k.value == translated), None)
